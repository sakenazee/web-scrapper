"""
Django settings for AmazonScrapper project.
...
SECRET_KEY = 'django-insecure-+go7*(j8575m((=oi@)(w-71m#ym9%stl26=d9wh=ty9jbv*s_'
...
ROOT_URLCONF = 'AmazonScrapper.urls'
...
WSGI_APPLICATION = 'AmazonScrapper.wsgi.application'
